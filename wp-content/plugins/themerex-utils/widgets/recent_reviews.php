 ...
 */
add_action( 'widgets_init', 'themerex_widget_recent_reviews_load' );

/**
 * Register our widget.
 */
function themerex_widget_recent_reviews_load() {
	register_widget('themerex_widget_recent_reviews');
}

/**
 * recent_reviews Widget class.
 */
class themerex_widget_recent_reviews extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_reviews', 'description' => __('Recent reviews', 'trx_utils'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'themerex_widget_recent_reviews');

		/* Create the widget. */
		parent::__construct( 'themerex_widget_recent_reviews', __('ThemeREX - Recent reviews', 'trx_utils'), $widget_ops, $control_ops );
	...
	function widget($args, $instance) {
		...
		$post_rating = 'reviews_avg'.(themerex_get_theme_option('reviews_first')=='author' ? '' : '2');
