 ...
 */
add_action( 'widgets_init', 'themerex_widget_recent_posts_load' );

/**
 * Register our widget.
 */
function themerex_widget_recent_posts_load() {
	register_widget('themerex_widget_recent_posts');
}

/**
 * Recent posts Widget class.
 */
class themerex_widget_recent_posts extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_posts', 'description' => __('The recent blog posts (extended)', 'trx_utils'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'themerex_widget_recent_posts');

		/* Create the widget. */
		parent::__construct( 'themerex_widget_recent_posts', __('ThemeREX - Recent Posts', 'trx_utils'), $widget_ops, $control_ops );
