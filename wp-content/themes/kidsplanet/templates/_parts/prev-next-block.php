...
if (!$post_data['post_protected']) {
	...
	if (!empty($post_options['dedicated'])) {
		...
		?>
		<div class="post_thumb post_nav"<?php themerex_show_layout($page_style=='single-portfolio-fullscreen' ? ' style="background-image:url('.esc_url($post_data['post_attachment']).');"' : ''); ?>>
			<?php 
			...
			$args = themerex_query_add_posts_and_cats($args, '', $post_data['post_type'], 
