 ...
 */
add_action( 'widgets_init', 'themerex_widget_flickr_load' );

/**
 * Register our widget.
 */
function themerex_widget_flickr_load() {
	register_widget( 'themerex_widget_flickr' );
}

/**
 * flickr Widget class.
 */
class themerex_widget_flickr extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_flickr', 'description' => __('Last flickr photos.', 'trx_utils') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 250, 'id_base' => 'themerex_widget_flickr' );

		/* Create the widget. */
		parent::__construct( 'themerex_widget_flickr', __('ThemeREX - Flickr photos', 'trx_utils'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'count' => 6, 'description' => __('Last flickr photos', 'trx_utils') );
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'flickr_username' )); ?>"><?php _e('Flickr ID idGettr:', 'trx_utils'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'flickr_count' )); ?>"><?php _e('Number of photos:', 'trx_utils'); ?></label>
